...
DATA = r'D:/programming_for_DS_v1 (1)/programming_for_DS_v1/data/moto_cleaned_EDA.csv'

SAVE_MODEL = r'D:/programming_for_DS_v1 (1)/programming_for_DS_v1/model/model.pkl'
...
def show_predict_page():
    ...
    so_km = st.slider("Số km đã đi", 0, 50000, 10000)
